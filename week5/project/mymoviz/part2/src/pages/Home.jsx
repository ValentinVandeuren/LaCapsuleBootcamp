...
const movieData = [
    {name: "Star Wars: l'Ascension de Skywalker", desc: "La conclusion de la saga skywalker.De nouvelles légendes vont naitre dans cette...", img: starwars, note: 4.8},
    {name: "Maléfique: Le pouvoir du mal", desc: "Maléfique est une belle jeune femme au coeur pur qui mène une vie idyllique au sein d'une paisible forêt dans un royaume où règnent le bonheur et l'harmonie. Un jour, une armée d'envahisseurs menace les frontières du pays et Maléfique, n'écoutant que son courage, s'élève en féroce protectrice de cette terre.", img: maleficentImage, note: 6.7},
    {name: "Jumanji: The Next Level", desc: "Lors d'une partie de Jumanji, un jeu très ancien, le jeune Alan est propulsé sous les yeux de son amie d'enfance, Sarah, dans un étrange pays. Il ne pourra s'en échapper que lorsqu'un autre joueur reprendra la partie et le libèrera sur un coup de dés.", img: jumanjiImage, note: 8.2},
